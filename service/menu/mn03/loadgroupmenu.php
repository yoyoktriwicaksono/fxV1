...
function load_childmn03($id2) {
    global $entityManager;
    $sql = "select a.*,b.DISPLAYTEXT,b.URL,b.TIPE from mst_tr_tcode a, mst_tcode b,mst_usertcode_groupmenu c where a.TCODEID=b.IDMENU and a.idtrtcode=c.idtrtcode and c.groupmenuid='$_groupmenuid' and PARENTID=$id2 order by urutan";
    $dbh = $entityManager->getConnection();
    $sth = $dbh->prepare($sql);
    $sth->execute();
    $rows = $sth->fetchAll();
